...
static int rtl8152_set_mac_address(struct net_device *netdev, void *p)
{
	...
	printk("r8152: rtl8152_set_mac_address\n");
...
static int set_ethernet_addr(struct r8152 *tp)
{
	...
	printk("r8152: set_ethernet_addr\n");
	...
	printk("r8152: set_ethernet_addr done, ret=%d\n", ret);
	return ret;
}
...
{
	printk("r8152: rtl8153b_runtime_enable %d\n", enable);
	if (enable) {
